...
- snort_parameter: Description of values. [default: value]
...
- name: snort
  ...
  roles:
    ...
    - role: robertdebock.snort
      snort_parameter: value
```

To install this role:
- Install this role individually using `ansible-galaxy install robertdebock.snort`

Sample roles/requirements.yml: (install with `ansible-galaxy install -r roles/requirements.yml
```
---
- name: robertdebock.bootstrap
- name: robertdebock.snort
```
